var Loop_end = enchant.Class.create(Terminal_symbol, {
  ...
  register_append: function(stage, loop) {
    this.addEventListener("touchend", function(e) {
      ...
      if (prog.is_x_main_head_inside(e.x)) {
        if (prog.is_y_main_head_inside(loop.start, e.y - this.height - 5)) {
      ...
      if (prog.is_x_s_head_inside(e.x)) {
        if (prog.is_y_s_head_inside(loop.start, e.y - this.height - 5)) {
      ...
      if (prog.is_x_h_head_inside(e.x)) {
        if (prog.is_y_h_head_inside(loop.start, e.y - this.height - 5)) {
      ...
      if (prog.is_x_d_head_inside(e.x)) {
        if (prog.is_y_d_head_inside(loop.start, e.y - this.height - 5)) {
      ...
      if (prog.is_x_c_head_inside(e.x)) {
        if (prog.is_y_c_head_inside(loop.start, e.y - this.height - 5)) {
