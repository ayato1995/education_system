var Stage = enchant.Class.create(enchant.Scene, {
  ...
  set_blocks: function() {
    ...
    b.push(new Loop());
    b[3].set_block(null, null, 10, 121, this.prog);
    b.push(new Func_id("spead", 0));
    b[4].set_block(null, 10, 195, "green", this.prog);
    b.push(new Func_id("heart", 0));
    b[5].set_block(null, 10, 232, "green", this.prog);
    b.push(new Func_id("dia", 0));
    b[6].set_block(null, 10, 269, "green", this.prog);
    b.push(new Func_id("clover", 0));
    b[7].set_block(null, 10, 306, "green", this.prog);
    return b;
  },
